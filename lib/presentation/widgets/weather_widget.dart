...
class WeatherWidget extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                if (isLoading && weather == null)
                  ...
                  _buildCompactWeatherBody(context, weather, isDark),
              ],
            ),
          ),
        ),
  ...
  Widget _buildCompactWeatherBody(
      BuildContext context, WeatherData weather, bool isDark) {
    return Column(
      children: [
        Row(
        ...
        // Micro Stats Bar (Terasa, Kelembapan, Angin dalam 1 baris ringkas)
        Container(
